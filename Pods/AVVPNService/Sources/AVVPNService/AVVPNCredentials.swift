...
public class AVVPNCredentials {
    ...
    public class IPSec: AVVPNCredentials {
        ...
        public init(title: String = "Top", server: String, username: String, password: String, shared: String) {
            self.shared = shared
    ...
    public class IKEv2: AVVPNCredentials {
        ...
        public init(title: String = "Top", server: String, username: String, password: String, remoteId: String, localId: String) {
